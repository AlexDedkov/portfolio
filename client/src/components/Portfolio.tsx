...
import TildaLogo from "../imgs/Tilda_logo_hotizontal_white.png"
        ...
        <div className="row">
          <div className="col-md-4">
            <div className="card bg-secondary">
              ...
              <img src={Githublogo} className="card-img-top cardimg" loading="lazy" alt="Project 1"/>
          ...
          <div className="col-md-4">
            <div className="card bg-secondary">
              {/* Use the imported image */}
              <img src={TildaLogo} loading="lazy" className="card-img-top cardimg cardtildaimg" alt="Project 2"/>
              <div className="card-body">
